...
import alpine from '../assets/img/alpine.svg'
...
const AboutMe = () => {
  return (
    <section id="aboutMe" className="bg-gray-400/20 rounded-3xl p-8 w-full">
        {/* <!-- Title --> */}
        <div>
          <h2 className="text-3xl text-zinc-200 font-bold mb-2">About</h2>
          ...
          <div className="p-4 flex flex-col items-center justify-center">
            <div className="my-1 flex flex-col md:flex-row gap-2 w-full">
              <div className="md:w-1/2 bg-zinc-900 shadow-lg drop-shadow-xl/25 text-zinc-200 rounded-xl p-4 flex items-center justify-center">
                <svg className="mr-4" fill="#FFB900" version="1.1" id="Uploaded to svgrepo.com" xmlns="http://www.w3.org/2000/svg"
                  xmlnsXlink="http://www.w3.org/1999/xlink" width="64px" height="64px" viewBox="0 0 32 32"
                  xmlSpace="preserve">
                  <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                  <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                  <g id="SVGRepo_iconCarrier">
                    <path className="blueprint_een"
                ...
                <div>
                  <h3 className="font-semibold text-white text-base">UI/UX</h3>
              ...
              <div className="md:w-1/2 bg-zinc-900 drop-shadow-xl/25 text-white rounded-xl p-4 flex items-center justify-center">
                ...
                <div>
                  <h3 className="font-semibold text-zinc-200 text-base">Web Development</h3>
                  <p className="text-sm text-zinc-400">Premium website development executed with professional expertise.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="overflow-hidden w-full py-4">
            <div className="marquee flex w-max animate-marquee">
              <div className="flex items-center space-x-20">
                <img src={html5} className="h-12 w-12 object-contain lg:h-20 lg:w-20" />
                <img src={css} className="h-12 w-12 object-contain lg:h-20 lg:w-20" />
                <img src={js} className="h-12 w-12 object-contain lg:h-20 lg:w-20" />
                <img src={nodeJs} className="h-12 w-12 object-contain lg:h-20 lg:w-20" />
                <img src={git} className="h-12 w-12 object-contain lg:h-20 lg:w-20" />
                <img src={github} className="h-12 w-12 object-contain lg:h-20 lg:w-20" />
                <img src={json} className="h-12 w-12 object-contain lg:h-20 lg:w-20" />
                <img src={eslint} className="h-12 w-12 object-contain lg:h-20 lg:w-20" />
                <img src={bootstrap} className="h-12 w-12 object-contain lg:h-20 lg:w-20" />
                <img src={tailwind} className="h-12 w-12 object-contain lg:h-20 lg:w-20" />
                <img src={alpine} className="h-12 w-12 object-contain lg:h-20 lg:w-20" />
                <img src={postman} className="h-12 w-12 object-contain lg:h-20 lg:w-20" />
              </div>
