  ...
  return (
    <aside id="profile" className="bg-gray-400/20 rounded-3xl p-8 text-center lg:w-1/3 max-h-max ">
      ...
      <div className="flex justify-center space-x-5 mb-6 text-gray-400">
        {/* GitHub */}
        <a className="sosmed-btn relative p-2 rounded-md group transition" href="https://github.com/Adytia855"
        ...
        {/* Instagram */}
        <a className="sosmed-btn relative p-2 rounded-md group transition" href="https://instagram.com/adytgriansyah"
        ...
        {/* LinkedIn */}
        <a className="sosmed-btn relative p-2 rounded-md group transition" href="https://linkedin.com/in/muhammadadytia"
